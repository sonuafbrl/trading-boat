...
import { Users, User, Calendar, TrendingUp, DollarSign, Eye } from 'lucide-react';
...
export default function AdminUsers() {
  ...
  const loadUsers = async () => {
    try {
      ...
      const data = await apiService.getAllUsers(skip, limit);
      setUsersData(data);
    } catch (err) {
                ...
                <div>
                  <p className="text-sm text-gray-700">
                    ...
                    <span className="font-medium">
                      {Math.min(currentPage * limit, usersData?.total || 0)}
                    </span>
                    {' '}of{' '}
